      ...
      try {
        ...
        const formattedTours = data.items.map((tour) => ({
          ...
          imageUrls: Array.isArray(tour.imageUrls)
            ...
            : [tour.imageUrls || ""],
          rating:
            tour.rating || Math.floor(Math.random() * 2) + 3 + Math.random(), // Random rating between 3-5 if not provided
        }));
      ...
      <section className="py-16 bg-gradient-to-b from-white to-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-8">
            No newest tours available at the moment
          </p>
          <button
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-gray-600">
              Discover our latest travel experiences
            </p>
          </div>
            ...
            <div className="relative h-[400px] lg:h-[500px] rounded-xl overflow-hidden">
              <img
                src={
                  ...
                  currentTour.coverImageUrl.trim() !== ""
              ...
              <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex items-center bg-gray-100 px-2 py-1 rounded">
                  ...
                  <span className="text-sm font-medium">
                    {currentTour.rating?.toFixed(1) || "4.5"}
                  </span>
                </div>
              </div>
              <p className="text-gray-600 text-lg mb-8">
                {currentTour.description ||
                  "Explore this amazing new destination with our latest tour offering."}
              </p>
                ...
                <div className="flex items-center text-gray-600">
                  ...
                  <div>
                    ...
                    <span className="text-sm">
                      {new Date(currentTour.startDate).toLocaleDateString()} -{" "}
                      {new Date(currentTour.endDate).toLocaleDateString()}
                    </span>
                  </div>
                </div>
                <div className="flex items-center text-gray-600">
